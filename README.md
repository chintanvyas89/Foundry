...
[`lsp-bridge-extension/swe-search-lsp-bridge-0.3.3.vsix`](lsp-bridge-extension/swe-search-lsp-bridge-0.3.3.vsix):

```bash
code --install-extension lsp-bridge-extension/swe-search-lsp-bridge-0.3.3.vsix
```
